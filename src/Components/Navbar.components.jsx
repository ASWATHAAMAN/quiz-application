  ...
  return (
    <main>
      ...
      <div className="flex justify-center items-center h-screen w-[100%]">
        <button type="button" className="border-2 px-[1.5rem] py-[0.25rem] rounded-lg border-green-700 bg-green-700 text-white text-[18px] font-[700] font-serif hover:bg-green-500 hover:border-green-500">START</button>
      </div>
    </main>
  );
};
